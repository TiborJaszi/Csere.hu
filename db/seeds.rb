...
Product.create :add_name => "Tej", :add_price => "300", :add_pic => "box.jpg", :created_at => Time.now, :updated_at => Time.now, :login_id => 1
Product.create :add_name => "Coca Cola", :add_price => "250", :add_pic => "box.jpg", :created_at => Time.now, :updated_at => Time.now, :login_id => 2
...
Product.create :add_name => "Egér", :add_price => "12000", :add_pic => "box.jpg", :created_at => Time.now, :updated_at => Time.now, :login_id => 1
...
Product.create :add_name => "Laptop", :add_price => "300000", :add_pic => "box.jpg", :created_at => Time.now, :updated_at => Time.now, :login_id => 2